...
exports.categoryOptionalSchema = exports.categorySchema = void 0;
...
exports.categoryOptionalSchema = joi_1.default.object({
    idCategoriaProducto: joi_1.default.number().integer().min(1).required().messages({
